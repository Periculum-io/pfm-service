...
echo -e "[Unit]\nDescription=pdf-parser-api\nAfter=network.target\nStartLimitIntervalSec=0\n\n[Service]\nUser=ubuntu\nGroup=www-data\nWorkingDirectory=/home/ubuntu/periculum-pdf-parser/pdf_parser_api/flask_api\nExecStart=/usr/local/bin/gunicorn -b localhost:8000 --chdir /home/ubuntu/periculum-pdf-parser/pdf_parser_api/flask_api app:app\nRestart=always\n\n[Install]\nWantedBy=multi-user.target" | sudo tee pdf-parser-api.service
