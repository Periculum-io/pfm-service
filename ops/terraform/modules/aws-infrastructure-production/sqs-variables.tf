variable "sqs_queue_name" {
  ...
  default = "insights-api"
}

variable "sqs_insights_consumer_queue_name" {
  type = string
  description = "Map of queue names where key is a name of the queue and value is bool indicating if it's FIFO type."
  default = "insights-consumer-api"
}

variable "sqs_insights_mono_integration_queue_name" {
  type = string
  description = "Map of queue names where key is a name of the queue and value is bool indicating if it's FIFO type."
  default = "insights-mono-integration"
}

variable "sqs_insights_dojah_integration_queue_name" {
  type = string
  description = "Map of queue names where key is a name of the queue and value is bool indicating if it's FIFO type."
  default = "insights-dojah-integration"
}
