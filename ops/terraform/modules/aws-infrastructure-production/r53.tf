...
data "aws_route53_zone" "r53_zone_insights_consumer_kenya" {
  zone_id = var.r53_hosted_zone_id_insights_consumer_kenya
}
...
resource "aws_route53_record" "r53_record_a_domain_insights_consumer_kenya_1" {
  zone_id = data.aws_route53_zone.r53_zone_insights_consumer_kenya.zone_id
  name    = var.r53_target_domain_insights_consumer_kenya_1
  type    = "A"
...
resource "aws_route53_record" "r53_record_a_domain_insights_consumer_kenya_2" {
  zone_id = data.aws_route53_zone.r53_zone_insights_consumer_kenya.zone_id
  name    = var.r53_target_domain_insights_consumer_kenya_2
  type    = "A"
