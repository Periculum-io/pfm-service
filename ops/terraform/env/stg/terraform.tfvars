...
# Infra related
ecs_cluster_name = "insights-ecs-cluster"
...
rds_secret_name = "pfm/staging/rds.v2"

# Routing related
alb_listener_routing_host_pfm_api = "api.staging.insights-periculum.com"
r53_hosted_zone_id = "Z0925464379UEHOR9ROUU"
r53_target_domain = "*.staging.insights-periculum.com"
...
frontend_base_url = "https://api.staging.insights-periculum.com"
...
insights_api_task_count = 2
insights_api_container_port = 8001
insights_api_container_host_port = 8001
insights_api_secret_manager_arn = "arn:aws:secretsmanager:us-east-1:962374658537:secret:insights/staging/insights-api-v5GDLb"
insights_api_sensitive_secret_arn = "arn:aws:secretsmanager:us-east-1:962374658537:secret:Insights/staging/sensitive-secrets-2xBY1q"
insights_api_allowed_cors_origin = "https://perilenda.staging.insights-periculum.com"
insights_api_auth0_domain = "https://periculum-insights-staging.us.auth0.com/"
insights_api_auth0_audience = "https://api.staging.insights-periculum.com"